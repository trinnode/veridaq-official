...
import { Wallet, Loader2, CheckCircle2, Sparkles, Copy } from "@/lib/icons"
...
const CREDIT_PACKS = [
  { label: "5 Verifications", credits: 5, usd: 7, eth: "0.005", amountWei: parseEther("0.005").toString() },
  { label: "10 Verifications", credits: 10, usd: 15, eth: "0.01", amountWei: parseEther("0.01").toString() },
  { label: "25 Verifications", credits: 25, usd: 35, eth: "0.02", amountWei: parseEther("0.02").toString() },
  { label: "50 Verifications", credits: 50, usd: 65, eth: "0.035", amountWei: parseEther("0.035").toString() },
  { label: "100 Verifications", credits: 100, usd: 120, eth: "0.06", amountWei: parseEther("0.06").toString() },
