...
export type User = { id: string; email: string; name: string; role: string; kycApproved?: boolean; alsoEmployer?: boolean; active?: boolean; deactivatedAt?: string | null; deactivationReason?: string | null }
type AuthCtx = {
  user: User | null
  loading: boolean
