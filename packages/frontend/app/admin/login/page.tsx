  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-void px-4">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/4 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-warning/[0.03] blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 h-[300px] w-[300px] rounded-full bg-accent/[0.02] blur-[80px]" />
        ...
        <div className="border-surface-border bg-surface-card/80 rounded-2xl border p-8 shadow-elevated backdrop-blur-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted">Restricted access — admin personnel only</p>
            </div>
          </div>
